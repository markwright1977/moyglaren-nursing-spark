...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-20">
      ...
      {/* Content with backdrop for accessibility */}
      <div className="container mx-auto relative z-10 py-16 md:py-24">
        <div className="max-w-2xl bg-background/90 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-elevated">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-primary leading-tight mb-6 animate-fade-in-up opacity-0 animation-delay-100">
            A Place to Call
            <span className="block text-cta">Home</span>
          </h1>

          <p className="text-lg md:text-xl text-muted-foreground max-w-xl mb-8 leading-relaxed animate-fade-in-up opacity-0 animation-delay-200">
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-6 animate-fade-in-up opacity-0 animation-delay-400">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xl md:text-2xl font-display font-bold text-primary">53</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xl md:text-2xl font-display font-bold text-primary">24/7</p>
